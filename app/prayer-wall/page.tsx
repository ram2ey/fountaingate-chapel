  ...
  return (
    <div className="space-y-6 pb-8">
      ...
      <div className="glass-panel p-6 sm:p-8 rounded-none border border-indigo-200 bg-indigo-50/80 shadow-md space-y-3 relative overflow-hidden">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 relative z-10">
          <div>
            ...
            <div className="p-3.5 rounded-none bg-white border border-indigo-100 shadow-xs mt-2">
          ...
          <button
            ...
            className="px-5 py-3 rounded-none bg-amber-400 hover:bg-amber-300 text-slate-950 font-extrabold text-xs shadow-md transition self-start lg:self-auto shrink-0"
          >
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs">
        <div className="p-4 rounded-none bg-white border border-slate-200 shadow-sm space-y-1">
        ...
        {urgentCount > 0 && (
          <div className="p-4 rounded-none bg-rose-50 border border-rose-200 shadow-sm space-y-1">
      ...
      {/* Status Tab Controls */}
      <div className="flex bg-slate-200/80 p-1 rounded-none border border-slate-300 max-w-md">
        <button
          onClick={() => setFilterTab('all')}
          className={`flex-1 py-2 rounded-none font-bold text-xs transition ${
        ...
        {isPastorOrAdmin && (
          <button
            ...
            className={`flex-1 py-2 rounded-none font-bold text-xs transition relative ${
        ...
        <div className="flex items-center gap-2 overflow-x-auto pb-1 scrollbar-none text-xs">
          ...
          {CATEGORIES.map(cat => (
            <button
              ...
              className={`px-3 py-1 rounded-none font-bold whitespace-nowrap transition border text-xs ${
                categoryFilter === cat
      ...
      <div className="space-y-4">
        {visibleRequests.length === 0 ? (
          <div className="text-center py-12 p-6 rounded-none bg-white border border-slate-200 space-y-3">
            <div className="w-12 h-12 rounded-none bg-indigo-50 text-indigo-600 mx-auto flex items-center justify-center font-bold text-xl">
              🙏
            </div>
            ...
            <button
              onClick={() => setShowSubmitModal(true)}
              className="px-4 py-2 rounded-none bg-indigo-600 text-white font-bold text-xs shadow-sm"
            >
              Submit Prayer Request
            </button>
          </div>
